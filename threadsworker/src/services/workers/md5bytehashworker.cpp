...
namespace twPro {
    ...
    Result<WORKER_CODES> MD5ByteHashWorker::doBlockWork(const std::shared_ptr<const twPro::DataUnit>& _dataUnit, const std::shared_ptr<twPro::DataUnit>& _resultUnit) const noexcept
    {
